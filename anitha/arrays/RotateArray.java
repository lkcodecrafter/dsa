...
public static List<Integer> rotateArray(List<Integer> arr, int k) {
    ...
    // last k elements
    result.addAll(arr.subList(n - k, n));

    // remaining elements
    result.addAll(arr.subList(0, n - k));
...
Take remaining → [1, 2, 3]

Final:
[4, 5, 1, 2, 3]
💡 Even Shorter (In-place using Collections)

If modifying original list is okay:
